...
Mesh::Mesh() : isSetEBO(false), isSetVBO(false), isSetVAO(false) {
...
void Mesh::setVertices(const void* vertices, int size, const int& VAO, const int& VBO) {
...
void Mesh::setIndices(const void* indices, int size, const int& EBO) {
...
void Mesh::setAttributes(int vaoPos, int count, GLenum type, bool normalized, int stride, const void* pos)
{
...
void Mesh::draw(GLenum fillMode, GLenum drawMode) {
