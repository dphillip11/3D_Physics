...
void main()
{
	...
	vec3 ambientComponent = vec3(0,1,1) * light.ambient;
	...
	vec3 diffuseComponent = light.diffuse * diffuseValue * vec3(0, 1, 1);
	//specular
	...
	vec3 specularComponent = vec3(0,1,1) * specularValue * light.specular;
